---
title: Allgemeine Informationen zur Nutzung des metasfresh Webservice (REST API)
layout: default
tags:
...
1. [Erlange Zugang zur metasfresh Application Server REST API](REST_API_durchsuchen_mittels_Swagger).
