...
1. In the field [**Marketing Campaign**](Create_MKTG_campaign), enter a part of the e-mail campaign and click on the matching result in the [drop-down list](Keyboard_shortcuts_reference).
