...
1. Trage das **Jahr** ein, für das Du eine neue Periode anlegen möchtest, z.B. "2050" <script>document.write(new Date().getFullYear())</script> | <script>document.write(new Date().getFullYear() + 1)</script>.
...
1. Stelle ein **Anfangsdatum** ein, z.B. "01.01.2050".
1. Lege ein geeignetes **Datumsformat** fest, sofern notwendig (z.B. *MMM-yy* für *Jan-20*).
