...
## Überblick
Für den Import von Produktdaten gemäß [IFA GmbH](https://www.ifaffm.de/de/ifa-gmbh.html) benötigst Du ein Importformat, in dem die **DB-Tabelle** *Import Pharma Product* eingestellt ist.
